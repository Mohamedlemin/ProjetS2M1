                ...
                <div class="card">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Nom" value="" id="nom">
                    </div>
                  </div>
                  <div class="form-group">
                    <label>Prenom</label>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="prenom" value="" id="prenom">
                    </div>
                  </div>
                      <div class="form-group">
                    <label>Adresse</label>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Adresse" value="" id="prenom">
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" value="" placeholder="username" id="user">
                    </div>
                  </div>
                      <div class="form-group">
                  ...
                  <button type="button" class="btn btn-outline-primary m-t-15 waves-effect" id="btn-save">Modifier</button>
