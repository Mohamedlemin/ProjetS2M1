                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                     <button href="#" class="btn btn btn-primary btn-rounded float-right" id="btn_add" ><i class="fas fa-plus-circle"></i> Ajouter Salle</button>
                                </div>
                                <div class="card-body">
                                            ...
                                            <table class="table table-striped v_center" id="tableSalle">
                                                ...
                                                <td> <button href="#" class="btn btn-icon btn-primary" ><i class="fas fa-plus-square"> </i></button>
                                                <button href="#" class="btn btn-icon btn-info btn-d"><i class="fas fa-eye"> </i></button>
                                               <a href="#" class="btn btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="supprimer salle"><i class="fas fa-trash-alt"></i> </a></td>
                                                </tr>
